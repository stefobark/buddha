...
class UsersController extends \BaseController {
	...
	public function show()
	{
		...
		$test = SphinxQL::raw("select json from rt_u_bills where json['sponsors'][0]['leg_id']='WAL000122'");
		...
		foreach($q as $id){
			...
			$u_primary[] = SphinxQL::raw("select json.id from rt_u_bills where json['sponsors'][0]['leg_id']='$f_id'");
		}
